...
export declare function getLoggerOption(level: LogLevel, options?: IEventOptions): any;
export declare function resolveLoggerOption(logger: IEventOptions['logger']): any;
